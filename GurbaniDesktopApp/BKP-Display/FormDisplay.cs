...
namespace GurbaniDesktopApp
{
    public partial class FormDisplay : Form
    {
        ...
        {
            //Size sz = TextRenderer.MeasureText(label3.Text, label3.Font, label3.Size, TextFormatFlags.WordBreak);
            //if (sz.Width > label3.Size.Width || sz.Height > label3.Size.Height)
            //{
            //    DecreaseFontSize2(label3);
            //}
        }
        ...
        {
            ControlPaint.DrawBorder(e.Graphics, this.pnlMain.ClientRectangle, Color.DarkBlue, ButtonBorderStyle.Solid);
        }
